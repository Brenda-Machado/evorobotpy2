...
class Algo(EvoAlgo):
    ...
    def evaluate(self, candidate):
        ...
        if self.bestsol is not None:
            ...
            for t in range(self.policy.nttrials):
                ...
                eval_rews_p, eval_length = self.policy.rollout(
    ...
    def run(self):
        ...
        self.steps = 0
        print(
            "CMA-TESTE: seed %d maxmsteps %d batchSize %d stepsize %lf noiseStdDev %lf wdecay %d symseed %d nparams %d"
            % (
                self.seed,
                self.maxsteps / 1000000,
                self.batchSize,
