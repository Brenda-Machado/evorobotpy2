...
class Algo(EvoAlgo):
    ...
    def setProcess(self):
        ...
        self.cma_es = cma.CMAEvolutionStrategy(self.center, self.noiseStdDev, {"popsize": self.batchSize * 2}) # CMA-ES initialization
    ...
    def optimize(self):
        ...
        self.cma_es = cma.CMAEvolutionStrategy(weights, self.noiseStdDev, {'popsize': self.batchSize})
        solutions = self.cma_es.ask()
        self.cma_es.tell(solutions, weights)
        g = self.cma_es.result[0][0]
